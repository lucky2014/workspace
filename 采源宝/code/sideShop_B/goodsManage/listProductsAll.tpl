{{#each this}}
    <div class="shoppingCar-product myicon-checked-box" status="{{manageStatusChange status}}" data-id="{{id}}">
        ...
        <div class="shoppingCar-product-content">
            ...
            <div class="product-content-box product-content">
                ...
                <p class="clearFix desc-parent">
                    <span>¥{{sellPrice}}<i class="desc">／赚{{profit originPrice cost}}</i></span>
